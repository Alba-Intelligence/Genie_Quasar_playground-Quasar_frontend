  ...
  <section class="section">
    <div class="container">
      ...
      <select v-model="selected">
        <option v-for="dep in depts" :key="dep.departement" :value="dep.departement">{{ dep.nccenr }}</option>
      </select>
...
// For path handling, see: https://quasar.dev/quasar-cli/handling-assets
import depts from 'public/Assets/Data/Vue3_Plotly_Example_depts2018'
